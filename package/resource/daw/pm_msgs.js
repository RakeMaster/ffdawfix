ffAddOnLoad(function() {
	...
	for(i=4;i<tds.length;i=i+3){
		...
		if(name!="" && name!="Письмо гласит" && name.indexOf("Вам выдано")==-1){
			tds[i].innerHTML=tds[i].textContent.replace(name,'<a target="_blank" href='+createPersLinkWithText(name)+'>'+name+'</a><img alt="" style="cursor:pointer; padding-left:3px;" title="Приватное сообщение" src="resource://ffdawfix/img/reply.gif">');
		}
	}
